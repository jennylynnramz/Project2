...
function createFeatures(SFevictionData) {
    ...
    d3.json(link, function(data2){
        ...
        let neighborhood2 = L.geoJson(data2, {
            // Style each feature 
  ...
  createMap(evictions, neighborhood2);
}


function createMap(evictions, neighborhood2) {
...
//   evictions.addTo(layers["evictions"]);
//   neighborhood2.addTo(layers["neighborhood2"]);
  ...
  var myMap = L.map("map", {
    ...
    zoom: 12,
    layers: [streetmap, evictions, neighborhood2]
  });
